...
public class RunExpedition
{
	...
	// ((GFXEffectFactory) EffectFactory.getSingleton()).setEffects(new
	// GFXEffects().getEffects());
	// ui = UserInterface.getUI();
	// initializeUI(si);
	// ExpeditionDisplay.thus = new OryxExpeditionDisplay(si, assets,
	// UIconfiguration);
	// break;
	//
	// case JCURSES_CONSOLE:
	...
	// ((CharEffectFactory) EffectFactory.getSingleton()).setEffects(new
	// CharEffects().getEffects());
	// ui = UserInterface.getUI();
	// initializeUI(csi);
	// break;
	// case SWING_CONSOLE:
